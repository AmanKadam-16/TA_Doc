...
class DeviceInfo
{
  ...
  String _readIosDeviceInfo(IosDeviceInfo data) {
    ...
    strDeviceInfo='${strDeviceInfo}identifierForVendor:${data.identifierForVendor}, ';
    strDeviceInfo='${strDeviceInfo}isPhysicalDevice:${data.isPhysicalDevice}, ';
    strDeviceInfo='${strDeviceInfo}utsname.sysname:${data.utsname.sysname}, ';
    strDeviceInfo='${strDeviceInfo}utsname.nodename:${data.utsname.nodename}, ';
    strDeviceInfo='${strDeviceInfo}utsname.release:${data.utsname.release}, ';
    strDeviceInfo='${strDeviceInfo}utsname.version:${data.utsname.version}, ';
    strDeviceInfo='${strDeviceInfo}utsname.machine:${data.utsname.machine}, ';
    }
    on  Exception catch(e)
    {
      strDeviceInfo="";
