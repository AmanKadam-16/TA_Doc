...
import 'dart:convert';
import 'package:mta/Data/ServerInteration/Result.dart';
...
/// Validate Login and Get Menu List //TOdo:Emplyee menulist pending
  Future<Result> GetLogin(AuthLogin objLoginInfo)
  async {
    Result objResult;
    final ApiInteraction objApiInteraction= ApiInteraction();
    try
    {
      String strEncrypted=await base64Encode(objLoginInfo.AuthEncryptedString.codeUnits);
